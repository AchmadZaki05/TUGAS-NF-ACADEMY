...
<>
 {/*hero*/}
    <div className="container my-5" style={{ backgroundColor: '#680000ff', color: 'white' }}>  <div className="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg" id="home-awal"> 
